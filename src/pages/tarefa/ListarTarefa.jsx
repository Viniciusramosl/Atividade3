...
const initialRows = [
  createData(1, 'Matemática', 'Trigonometria', '2022-01-01', '2022-01-02', 'Concluída','Aula'),
  createData(2, 'Geografia', 'Geopolitica', '2022-01-03', '2022-01-04', 'Em Andamento','Aula'),
  createData(3, 'Historia', 'I Guerra mundial', '2022-01-04', '2022-01-05', 'Em Andamento','Atividade'),
  createData(4, 'Historia', 'I Guerra Mundial', '2022-01-05', '2022-01-06', 'Em Andamento','Aula'),
  createData(5, 'Portugues', 'Barroco', '2022-01-06', '2022-01-07', 'Em Andamento','Atividade'),
  createData(6, 'Artes', 'Historia da Arte', '2022-01-07', '2022-01-08', 'Aguardando','Trabalho'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Programação de Aulas e Tarefas"
        /> 
        <CardContent>
